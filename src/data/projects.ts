...
export const projects: Project[] = [
  {
    ...
    thumbnail: thumb('sarga-main'),
    coverImage: cover('sarga-main'),
  ...
  },
  {
    ...
    thumbnail: thumb('sarga-horse-racing'),
    coverImage: cover('sarga-horse-racing'),
    category: 'Corporate Website',
    status: 'in-progress',
    featured: true,
    year: '2026',
  ...
  },
  {
    ...
    thumbnail: thumb('sarga-motorsport'),
    coverImage: cover('sarga-motorsport'),
    category: 'Corporate Website',
    status: 'in-progress',
    featured: true,
    year: '2026',
  ...
  },
  {
    ...
    thumbnail: thumb('fif-affiliate'),
    coverImage: cover('fif-affiliate'),
    category: 'Dashboard',
    status: 'in-progress',
    featured: true,
    year: '2026',
  ...
  },
  {
    ...
    thumbnail: thumb('ceo-suite'),
    coverImage: cover('ceo-suite'),
  ...
  },
  {
    ...
    thumbnail: thumb('aralia-hris'),
    coverImage: cover('aralia-hris'),
    category: 'HRIS',
    status: 'live',
    featured: true,
    year: '2025',
  ...
  },
  {
    ...
    thumbnail: thumb('gcu-wms'),
    coverImage: cover('gcu-wms'),
  ...
  },
  {
    ...
    thumbnail: thumb('aloshop'),
    coverImage: cover('aloshop'),
    category: 'E-Commerce',
    status: 'in-progress',
    featured: false,
    year: '2026',
  ...
  },
  {
    ...
    thumbnail: thumb('simbadda'),
    coverImage: cover('simbadda'),
    category: 'E-Commerce',
    status: 'in-progress',
    featured: false,
    year: '2026',
  ...
  },
  {
    ...
    thumbnail: thumb('supermall-karawaci'),
    coverImage: cover('supermall-karawaci'),
    category: 'Membership',
    status: 'in-progress',
    featured: false,
    year: '2026',
  ...
  },
  {
    ...
    thumbnail: thumb('roda2'),
    coverImage: cover('roda2'),
    category: 'E-Commerce',
    status: 'in-progress',
    featured: false,
    year: '2024',
